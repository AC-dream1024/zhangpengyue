window.CONFIG = {
    ...
    generateEndlessLevel(waveN) {
        ...
        // ---------- Maze size growth: start at the final campaign size ----------
        // Endless mode should feel like a full-sized battlefield from wave one.
        // Keep it aligned with the last campaign level, then grow gradually.
        const finalLevel = CONFIG.LEVELS[CONFIG.LEVELS.length - 1];
        const baseCols = finalLevel.cols;
        const baseRows = finalLevel.rows;
