...
class VictoryScene extends Scene {
    ...
    createVictory() {
        ...
        let nextLevelBtn = '';
        if (!isFinalLevel) {
            nextLevelBtn = '<button class="btn" id="btn-next">▶ 下一关</button>';
        } else {
            nextLevelBtn = '<button class="btn" id="btn-next" style="background:linear-gradient(135deg,#00ff88,#00cc66);">🏆 通关全部关卡!</button>';
        }
