window.Input = {
    ...
    _initMobile() {
        ...
        // The maze remains playable in portrait mode; do not block the game with a
        // rotate-device overlay. The stage and controls resize fluidly in CSS.
        const checkOrientation = () => document.body.classList.remove('show-portrait-hint');
