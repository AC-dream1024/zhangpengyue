class GameOverScene extends Scene {
    ...
    createGameOver() {
        ...
        if (isNewRecord) {
            localStorage.setItem('starfighter_highscore', game.score.toString());
        }

        const earnedPoints = Math.floor(game.score / 10);
        const shipConfig = CONFIG.SHIP_TYPES[game.selectedShip] || CONFIG.SHIP_TYPES.judgment;
        ...
        this.ui = this.createUI(`
            ...
            <div class="info-panel" style="text-align: left;">
                ...
                <div><span class="label">击杀敌机:</span> <span class="value">${game.enemiesKilled}</span></div>
                <div><span class="label">使用战机:</span> <span class="value">${shipConfig.icon || ''} ${shipConfig.name}</span></div>
            ...
            <button class="btn" id="btn-shop">🛒 前往技能商店</button>
